...
const BusinessSection = () => {
  return (
    <section id="business" className="py-24 relative overflow-hidden bg-background/50">
      {/* Background Gradient */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="text-lg text-gray-300 mb-6">
              Integrate our AI solutions into your business workflow to automate tasks, gain valuable insights, and drive growth. No technical expertise required.
            </p>
            <ul className="space-y-4 mb-8">
              {['Automated workflow optimization', 'Customer behavior analysis', 'Predictive marketing strategies', 'Personalized user experiences'].map((item, index) => (
              ...
              <div className="glass-morphism relative overflow-hidden rounded-xl border border-white/10 p-1">
                <div className="bg-black/40 rounded-lg p-6">
                  <div className="flex items-center justify-between mb-6">
                    <div className="text-xl font-semibold">AI Growth Dashboard</div>
